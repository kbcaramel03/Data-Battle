...
OUTPUT_DIR = Path("catboost_simple_outputs")
...
USE_ALERT_INTERNAL_FEATURES = True  # passe à True pour tester S2
...
# gap depuis dernier éclair du même aéroport
...
# ============================================================
# FEATURES DE DYNAMIQUE SIMPLIFIEES
# ============================================================
# ratios court/moyen terme
model_df["ratio_lt20_5min_over_30min"] = model_df["cnt_lt20_5min"] / (model_df["cnt_lt20_30min"] + 1.0)
model_df["ratio_20_30_5min_over_30min"] = model_df["cnt_20_30_5min"] / (model_df["cnt_20_30_30min"] + 1.0)
...
# tendance de distance
model_df["trend_dist_10min_minus_30min"] = model_df["mean_dist_10min"] - model_df["mean_dist_30min"]

# tendance d'activité proche
model_df["trend_lt20_10min_minus_30min"] = model_df["cnt_lt20_10min"] - model_df["cnt_lt20_30min"]
...
# ============================================================
log_cols = [
    "cnt_all_5min", "cnt_all_10min", "cnt_all_30min",
    "cnt_lt20_5min", "cnt_lt20_10min", "cnt_lt20_30min",
    "cnt_20_30_5min", "cnt_20_30_10min", "cnt_20_30_30min",
    "cnt_cg_5min", "cnt_cg_10min", "cnt_cg_30min",
...
# ============================================================
# FEATURES FINALES SIMPLIFIEES (S1)
# ============================================================
candidate_features = [
    # contexte
    "airport", "season", "month",
    ...
    # versions log
    "log1p_cnt_all_5min", "log1p_cnt_all_10min", "log1p_cnt_all_30min",
    "log1p_cnt_lt20_5min", "log1p_cnt_lt20_10min", "log1p_cnt_lt20_30min",
    "log1p_cnt_20_30_5min", "log1p_cnt_20_30_10min", "log1p_cnt_20_30_30min",
    "log1p_cnt_cg_5min", "log1p_cnt_cg_10min", "log1p_cnt_cg_30min",

    # gaps
    "gap_prev_sec_airport",
    "gap_since_last_lt20_sec",
    "gap_since_last_cg_lt20_sec",
    "log1p_gap_prev_sec_airport",
    "log1p_gap_since_last_lt20_sec",
    "log1p_gap_since_last_cg_lt20_sec",

    # spatial utile
    "min_dist_10min", "mean_dist_10min", "mean_dist_30min",

    # intensité utile
    "mean_abs_amp_10min",

    # transition de fin
    "ratio_far_vs_close_10min",
    "ratio_lt20_5min_over_30min",
    "ratio_20_30_5min_over_30min",
    "share_lt20_10min",
    "share_20_30_10min",
    "trend_dist_10min_minus_30min",
    "trend_lt20_10min_minus_30min",
    "close_minus_far_10min",
    "gap_ratio_cg_lt20_vs_airport",
]

# ============================================================
# VERSION S2 OPTIONNELLE
# ============================================================
if USE_ALERT_INTERNAL_FEATURES:
    candidate_features += [
        "rank_in_alert",
        "elapsed_since_alert_start_sec",
        "gap_prev_sec_alert",
    ]
...
# SAVE MODEL
# ============================================================
model.save_model(str(OUTPUT_DIR / "catboost_simplified_model.cbm"))
